...
public class TypeScriptFetchPactClientCodegen extends AbstractTypeScriptClientCodegen {
    ...
    public TypeScriptFetchPactClientCodegen() {
        super();
        this.outputFolder = "generated-code" + File.separator + "typescript-fetch-pact";
